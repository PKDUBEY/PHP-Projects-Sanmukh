        ...
        <div class="our-team module">
        	<div class="section-title-wrapper row">
            	<div class="section-title">
                	<h2>Meet Our <span>Directors</span></h2>
                ...
                <div class="teams-wrapper side-controls">
                	...
                	<div class="doctor-column">
                        <div class="doctor">
                            <div class="doctor-thumb">
                                <a href="single-doctor.php">
                                    <img src="images/help/doctor1.jpg" alt="Doctor Doe" />
                                </a>
                                <a href="single-doctor.php" class="button secondary">
                                    Visit Profile
                                </a>    
                            </div><!-- Doctor thumb /-->
                    ...
                    <div class="doctor-column">
                        <div class="doctor">
                            <div class="doctor-thumb">
                                <a href="single-doctor.php">
                                    <img src="images/help/doctor2.jpg" alt="Doctor Doe" />
                                </a>
                                <a href="single-doctor.php" class="button secondary">
                                    Visit Profile
                                </a>    
                    ...
                    <div class="doctor-column">
                        <div class="doctor">
                            <div class="doctor-thumb">
                                <a href="single-doctor.php">
                                    <img src="images/help/doctor5.jpg" alt="Doctor Doe" />
                                </a>
                                <a href="single-doctor.php" class="button secondary">
                                    Visit Profile
                                </a>    
                    ...
                    <div class="doctor-column">
                        <div class="doctor">
                            <div class="doctor-thumb">
                                <a href="single-doctor.php">
                                    <img src="images/help/doctor4.jpg" alt="Doctor Doe" />
                                </a>
                                <a href="single-doctor.php" class="button secondary">
                                    Visit Profile
                                </a>    
                    ...
                    <div class="doctor-column">
                        <div class="doctor">
                            <div class="doctor-thumb">
                                <a href="single-doctor.php">
                                    <img src="images/help/doctor6.jpg" alt="Doctor Doe" />
                                </a>
                                <a href="single-doctor.php" class="button secondary">
                                    Visit Profile
                                </a>    
        ...
        <div class="footer">
                ...
                <div class="row">
                    ...
                    <div class="large-3 medium-6 small-12 columns footer-widget quick-links">
                        ...
                        <ul  class="menu vertical">
                            <li><a href="services.php">Lenses</a></li>    
                            <li><a href="services.php">Eye Glass</a></li>
                            <li><a href="services.php">Eye Frames</a></li>
                            <li><a href="services.php">Repairing</a></li>
                            <li><a href="services.php">Computerized</a></li>
                            <li><a href="services.php">Alphabetical</a></li>
                        </ul>
                        <ul  class="menu vertical">
                            <li><a href="services.php">Lasik</a></li>    
                            <li><a href="services.php">Fix Vision</a></li>
                            <li><a href="services.php">Drops</a></li>
                            <li><a href="services.php">Team</a></li>
                            <li><a href="services.php">Policy</a></li>
            ...
            <div class="footerbottom">
                <div class="row">
                    ...
                    <div class="medium-6 small-12 columns">
                        <div class="copyrightinfo">2016 &copy; <a href="www.mypdtechnology.com" target="_blank">PD Technology Creations Vision</a> All Rights Reserved.</div>
                    </div><!-- left side /-->
